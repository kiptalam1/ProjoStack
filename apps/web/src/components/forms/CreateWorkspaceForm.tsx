...
export default function CreateWorkspaceForm({ isOpen, setIsOpen }: ModalProps) {
    ...
    <div
      ...
      <form
        ...
        <div className="flex flex-col my-5 gap-2 ">
          <label className="text-sm">Enter workspace name:</label>
          <input type="text"
        ...
        <div className="flex items-center justify-between gap-3">
          <button
            type="button"
            onClick={() => setIsOpen(false)}
            className="bg-gray-500 rounded-md text-white px-1 py-0.5 text-sm font-semibold hover:bg-red-400 transition-colors duration-150 cursor-pointer disabled:cursor-not-allowed">Cancel</button>
          <button
            type="submit"
